...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="Single_Banner cutted_B">
        <img src="https://himalayaoptical.com/cdn/shop/files/1640x720-W-Banner_Vogue_1_9af033c5-2779-41cd-b7ea-d60daae1ea30.jpg?v=1646311467" alt="" />
      </div>
    </>
  );
};
